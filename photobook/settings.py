...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'photobook/templates')
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# AWS_STORAGE_BUCKET_NAME_ASSETS = config('AWS_STORAGE_BUCKET_NAME_ASSETS')
# AWS_S3_CUSTOM_DOMAIN = '%s.s3.amazonaws.com' % AWS_STORAGE_BUCKET_NAME_ASSETS
